...
const btnSkylight = document.getElementById('btn-skylight');
const btnPlay = document.getElementById('btn-play');
const btnExport = document.getElementById('btn-export');
const btnClear = document.getElementById('btn-clear');
const allBtns = [btnWall, btnDiag, btnErase, btnHero, btnBall, btnCrate, btnWeb, btnPlate, btnLiftwall, btnHighland, btnSkylight, btnWire, btnPlay];
...
// 模式元数据
const HOVER_MODES    = new Set(['place_hero','place_ball','place_crate','web','plate','liftwall','skylight','wire']);
const HIGHLIGHT_MODES = new Set(['place_hero','place_ball','place_crate','web','plate','liftwall','skylight']);
const BLOCKED_AS_WALL_MODES = new Set(['web','plate','liftwall','skylight']);
const DRAG_MODES     = new Set(['wall','diag','erase','highland','skylight']);
...
const modeLabels = {
  ...
  'skylight':  '模式: 天窗 — 点击/拖拽在空地上放置天窗（取消高度上限）',
...
const activeBtns = {
  ...
  'place_hero': btnHero, 'place_ball': btnBall, 'place_crate': btnCrate, 'web': btnWeb, 'plate': btnPlate, 'liftwall': btnLiftwall, 'highland': btnHighland, 'skylight': btnSkylight, 'wire': btnWire, 'play': btnPlay
};
